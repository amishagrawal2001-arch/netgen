...
_icon = None
# v0.5.116: prefer netgen.ico (the speedometer+packet app icon
# generated by scripts/generate_app_icon.py). Older lookup paths
# kept as fallbacks so a partially-rebuilt checkout doesn't
# bottom out at the toolbar add.png.
for guess in (
    "resources/icons/netgen.ico",
    "resources/icons/ostg.ico",
