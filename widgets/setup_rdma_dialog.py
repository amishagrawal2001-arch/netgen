...
class SetupRdmaDialog(QDialog):
    ...
    def __init__(self, server_url: str, parent=None):
        ...
        intro = QLabel(
            ...
            "Installs the RDMA stack on <b>" + self._short_host() + "</b>:"
            "<ul>"
            "<li><code>libibverbs-dev</code>, <code>rdma-core</code> — userspace RDMA</li>"
            "<li><code>perftest</code> — ib_send_bw / ib_read_bw / ib_write_bw</li>"
            "<li><code>ibverbs-utils</code>, <code>infiniband-diags</code> — ibv_devices, ibstat</li>"
            "<li><code>libmlx5-dev</code> — Mellanox PMD headers (optional, may fail without MOFED repo)</li>"
            "</ul>"
            "Loads <code>ib_uverbs</code> / <code>rdma_cm</code> / <code>ib_umad</code> "
            "kernel modules and persists them across reboots.<br><br>"
